                ...
                <section id="content">
                    ...
                    <div className="flex-first">
                        ...
                        <div className="right-first">
                                ...
                                for each trick over 6 tricks. So if <span class="left-player-name">Mike</span> and <span class="right-player-name">Lisa</span> get 8 tricks and <span class="bottom-player-name">You</span> and <span class="top-player-name">Bill</span> get 5, then <span class="left-player-name">Mike</span> and <span class="right-player-name">Lisa</span>
                                get 2 points but <span class="bottom-player-name">You</span> and <span class="top-player-name">Bill</span> get no points. Points are tracked between rounds and the first team to get
